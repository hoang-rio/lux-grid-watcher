...
function SolarPV({ inverterData, displayInverterData, isSSEConnected }: ICProps) {
  ...
  return (
    <div className="pv flex-1">
      <div className="icon col align-center">
        <div className="col align-center">
          <GeneralValue
            ...
            value={isSSEConnected ? data.p_pv : 0}
            unit=" W"
          />
        ...
        <div
          className={`y-arrow ${
            data.p_pv == 0 || !isSSEConnected ? "none" : ""
          }`}
        ></div>
      </div>
      <div className="pv-texts power flex-1">
        <PVPowerValue
          label={t('PV1')}
          pValue={isSSEConnected ? data.p_pv_1 : 0}
          vValue={isSSEConnected ? data.v_pv_1 : 0}
        />
        <PVPowerValue
          label={t('PV2')}
          pValue={isSSEConnected ? data.p_pv_2 : 0}
          vValue={isSSEConnected ? data.v_pv_2 : 0}
        />
        <PVPowerValue
          label={t('totalPV')}
          pValue={isSSEConnected ? data.p_pv : 0}
        />
      </div>
    </div>
  );
