...
class DailyChart(Base):
    ...
    pv: Mapped[int] = mapped_column(Integer, nullable=False)
    battery_charged: Mapped[int] = mapped_column(Integer, nullable=False)
    battery_discharged: Mapped[int] = mapped_column(Integer, nullable=False)
    grid_import: Mapped[int] = mapped_column(Integer, nullable=False)
    grid_export: Mapped[int] = mapped_column(Integer, nullable=False)
